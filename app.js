...
//Private constructors for expence and income inputs
...
//Because of closures inner functions have an access to variables and functions of outter function
	return {
		getInput: function() {
			return {
				 type: document.querySelector(DOMstrings.inputType).value, // Will be either inc or exp
				 description: document.querySelector(DOMstrings.inputDescription).value,
				 value: parseFloat(document.querySelector(DOMstrings.inputValue).value)// Will contain not a string but a number in the value vield
			}
		},
		...
		//Here we will remove an item from the User Interface with removeChild method
		deleteListItem: function(selectorID) {
			var el = document.getElementById(selectorID)
			el.parentNode.removeChild(el);
		},

		//Here we will make empty our entry fields after enter the data from them
		clearFields: function() {			
			...
			// We take from Array prototype method slice to convert the list(in this case) into an array;
...
})(budgetController, UIController); //Here  we pass our earlier created objects as arguments with different name to make controller module more independent
